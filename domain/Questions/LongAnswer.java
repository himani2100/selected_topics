...
/**
 * A question that provides a prompt that requires a quiz-taker to write a response that can span multiple paragraphs
...
public class LongAnswer extends Question{
    ...
    //region Constructor
    public LongAnswer(String questionText)
    {
        super(questionText);
    }

    public LongAnswer(String questionText, int minLen){
        super(questionText);
        this.setMinLen(minLen);
    }

    public LongAnswer(String questionText, int minLen, int maxLen){
        super(questionText);
        this.setMinLen(minLen);
